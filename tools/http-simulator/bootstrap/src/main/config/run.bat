@echo off
rem -------------------------------------------------------------------------
rem Restcomm HTTP Simulator Bootstrap Script for Win32
rem -------------------------------------------------------------------------
...
:RESTART
"%JAVA%" %JAVA_OPTS% -Djava.ext.dirs="%SIMULATOR_ENDORSED_DIRS%" -Dmbrola.base="%SIMULATOR_HOME%/mbrola" -classpath "%SIMULATOR_CLASSPATH%" org.mobicents.ussdgateway.tools.httpsimulator.bootstrap.Main %*
