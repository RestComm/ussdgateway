...
### ====================================================================== ###
##                                                                          ##
##  RestComm HTTP Simulator Bootstrap Script                                 ##
##                                                                          ##
### ====================================================================== ###
...
echo ""
      ...
      "$JAVA" $JAVA_OPTS \
         ...
         org.mobicents.ussdgateway.tools.httpsimulator.bootstrap.Main "$@"
      SIMULATOR_STATUS=$?

#java -Djava.ext.dirs=`pwd`/lib -Dmms.home=. -cp .:mms-standalone-2.0.0.BETA1-SNAPSHOT.jar org.mobicents.ussdgateway.tools.httpsimulator.bootstrap
