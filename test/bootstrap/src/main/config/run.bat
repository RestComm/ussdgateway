...
if "%SMSC_CLASSPATH%" == "" set RUN_CLASSPATH=%RUNJAR%
if "%RUN_CLASSPATH%" == "" set RUN_CLASSPATH=%SMSC_CLASSPATH%;%RUNJAR%

set SMSC_CLASSPATH=%RUN_CLASSPATH%
...
:RESTART
"%JAVA%" %JAVA_OPTS% -Djava.ext.dirs="%SMSC_ENDORSED_DIRS%" -classpath "%SMSC_CLASSPATH%" org.mobicents.ussd.server.bootstrap.Main 
