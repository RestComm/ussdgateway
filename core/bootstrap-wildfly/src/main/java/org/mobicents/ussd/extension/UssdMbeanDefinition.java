 ...
 */
public class UssdMbeanDefinition extends SimpleResourceDefinition {
    ...
    public static final UssdMbeanDefinition INSTANCE = new UssdMbeanDefinition();
    ...
    private UssdMbeanDefinition() {
        super(MBEAN_PATH,
                UssdExtension.getResourceDescriptionResolver(MBEAN),
                UssdMbeanAdd.INSTANCE,
                UssdMbeanRemove.INSTANCE);
    }

    @Override
    public void registerChildren(ManagementResourceRegistration resourceRegistration) {
        super.registerChildren(resourceRegistration);
        resourceRegistration.registerSubModel(UssdMbeanPropertyDefinition.INSTANCE);
    }
