...
public class UssdMbeanPropertyDefinition extends SimpleResourceDefinition {
    ...
    public static final UssdMbeanPropertyDefinition INSTANCE = new UssdMbeanPropertyDefinition();
    ...
    private UssdMbeanPropertyDefinition() {
        super(PROPERTY_PATH,
                UssdExtension.getResourceDescriptionResolver(UssdMbeanDefinition.MBEAN + "." + PROPERTY),
                UssdMbeanPropertyAdd.INSTANCE,
                UssdMbeanPropertyRemove.INSTANCE);
    }
