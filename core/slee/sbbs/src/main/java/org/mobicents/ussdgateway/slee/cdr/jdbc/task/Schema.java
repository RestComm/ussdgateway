...
final class Schema {
    ...
    public static final String _TYPE_COLUMN_L_SSN = "TINYINT";
    public static final String _TYPE_COLUMN_L_RI = "TINYINT";
    public static final String _TYPE_COLUMN_L_GT_I = "TINYINT";
    public static final String _TYPE_COLUMN_L_GT_DIGITS = "VARCHAR(18)";
    public static final String _TYPE_COLUMN_R_SPC = "INT";
    public static final String _TYPE_COLUMN_R_SSN = "TINYINT";
    public static final String _TYPE_COLUMN_R_RI = "TINYINT";
    public static final String _TYPE_COLUMN_R_GT_I = "TINYINT";
    ...
    public static final String _TYPE_COLUMN_OR_NATURE = "TINYINT";
    public static final String _TYPE_COLUMN_OR_PLAN = "TINYINT";
    public static final String _TYPE_COLUMN_OR_DIGITS = "VARCHAR(18)";
    public static final String _TYPE_COLUMN_DE_NATURE = "TINYINT";
    public static final String _TYPE_COLUMN_DE_PLAN = "TINYINT";
    public static final String _TYPE_COLUMN_DE_DIGITS = "VARCHAR(18)";
    public static final String _TYPE_COLUMN_ISDN_NATURE = "TINYINT";
    public static final String _TYPE_COLUMN_ISDN_PLAN = "TINYINT";
    public static final String _TYPE_COLUMN_ISDN_DIGITS = "VARCHAR(18)";
    public static final String _TYPE_COLUMN_VLR_NATURE = "TINYINT";
    public static final String _TYPE_COLUMN_VLR_PLAN = "TINYINT";
