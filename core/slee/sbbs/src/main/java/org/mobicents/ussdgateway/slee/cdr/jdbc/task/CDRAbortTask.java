 ...
 * 
 */
public class CDRAbortTask extends CDRTaskBase {

    private final AbortType abortReason;
    /**
     * @param callerID
     * @param callingID
     * @param dialogId
     */
    public CDRAbortTask(final Tracer tracer, USSDCDRState state,AbortType abortReason) {
        super(tracer,state);
    ...
    public void callParentOnFailure(final ChargeInterfaceParent parent, final String message, final Throwable t) {
        parent.recordGenerationFailed(RecordType.ABORT, message, t);
    }
    ...
    public void callParentOnSuccess(ChargeInterfaceParent parent) {
        parent.recordGenerationSucessed(RecordType.ABORT);
    }
...
//            _COLUMN_TERMINATE_REASON+ <-- 'Success'
          preparedStatement.setString(27,abortReason.toString());
