 ...
 * 
 */
public class CDRTimeoutTask extends CDRTaskBase {
     ...
     * @param dialogId
     */
    public CDRTimeoutTask(final Tracer tracer, USSDCDRState state,TimeoutType timeoutType) {
        super(tracer,state);
    ...
    public void callParentOnFailure(final ChargeInterfaceParent parent, final String message, final Throwable t) {
        parent.recordGenerationFailed(RecordType.TIMEOUT, message, t);
    }
    ...
    public void callParentOnSuccess(ChargeInterfaceParent parent) {
        parent.recordGenerationSucessed(RecordType.TIMEOUT);
    }
...
//            _COLUMN_TERMINATE_REASON+ <-- 'Success'
          preparedStatement.setString(27,timeoutType.toString());
