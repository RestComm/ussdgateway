...
Carrier Grade Performance:::
  ...
  A single Mobicents USSD node can process 1000's of USSD/sec and can be adapted to the needs of telecom service providers of different sizes in any country reducing your CAPEX and OPEX costs. 
