...
The {this-platform} jSS7 Stack User Guide in the [path]_mobicents-ussdgateway-<version>/docs/jss7/_ folder will assist you in configuring and managing the SS7 Stack.
